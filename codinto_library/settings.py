"""
Django settings for codinto_library project.
...
WSGI_APPLICATION = 'codinto_library.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'HOST': config('DB_HOST'),  # Set to your PostgreSQL host, or leave as 'localhost'
